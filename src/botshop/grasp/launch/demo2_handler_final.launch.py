...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        TimerAction(
            period=1.0,
            actions=[
                # Execute a new terminal command to launch the Demo2 launch file after 10 seconds
                ExecuteProcess(
                    cmd=['gnome-terminal', '--', 'ros2', 'launch', 'moveit_task_constructor_demo', 'demo2_handler_2.launch.py'],
                    output='screen'
                )
            ]
        )
