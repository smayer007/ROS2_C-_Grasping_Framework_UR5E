...
#include "robotiq_2f_urcap_adapter/msg/detail/gripper_command__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robotiq_2f_urcap_adapter::msg::GripperCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robotiq_2f_urcap_adapter::msg::GripperCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robotiq_2f_urcap_adapter::msg::GripperCommand *>(
    untyped_ros_message);
...
{
  return &robotiq_2f_urcap_adapter::msg::typesupport_fastrtps_cpp::_GripperCommand__handle;
}
