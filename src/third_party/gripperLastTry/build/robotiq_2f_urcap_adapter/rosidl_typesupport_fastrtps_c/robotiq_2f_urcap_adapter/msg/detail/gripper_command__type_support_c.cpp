...
#include "robotiq_2f_urcap_adapter/msg/detail/gripper_command__rosidl_typesupport_fastrtps_c.h"
...
using _GripperCommand__ros_msg_type = robotiq_2f_urcap_adapter__msg__GripperCommand;
...
static uint32_t _GripperCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robotiq_2f_urcap_adapter__msg__GripperCommand(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robotiq_2f_urcap_adapter__msg__GripperCommand;
    is_plain =
      (
...
static size_t _GripperCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotiq_2f_urcap_adapter__msg__GripperCommand(
