...
#include "robotiq_2f_urcap_adapter/action/detail/gripper_command__rosidl_typesupport_fastrtps_c.h"
...
#include "robotiq_2f_urcap_adapter/msg/detail/gripper_command__functions.h"  // command

// forward declare type support functions
size_t get_serialized_size_robotiq_2f_urcap_adapter__msg__GripperCommand(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_robotiq_2f_urcap_adapter__msg__GripperCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotiq_2f_urcap_adapter, msg, GripperCommand)();


using _GripperCommand_Goal__ros_msg_type = robotiq_2f_urcap_adapter__action__GripperCommand_Goal;
  ...
  // Field name: command
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, robotiq_2f_urcap_adapter, msg, GripperCommand
      )()->data);
...
size_t get_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_Goal(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GripperCommand_Goal__ros_msg_type * ros_message = static_cast<const _GripperCommand_Goal__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_robotiq_2f_urcap_adapter__msg__GripperCommand(
...
static uint32_t _GripperCommand_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotiq_2f_urcap_adapter
size_t max_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: command
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_robotiq_2f_urcap_adapter__msg__GripperCommand(
  ...
  if (is_plain) {
    ...
    using DataType = robotiq_2f_urcap_adapter__action__GripperCommand_Goal;
    is_plain =
      (
...
static size_t _GripperCommand_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_Goal(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotiq_2f_urcap_adapter, action, GripperCommand_Goal)() {
...
using _GripperCommand_Result__ros_msg_type = robotiq_2f_urcap_adapter__action__GripperCommand_Result;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotiq_2f_urcap_adapter
size_t get_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GripperCommand_Result__ros_msg_type * ros_message = static_cast<const _GripperCommand_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotiq_2f_urcap_adapter
size_t max_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robotiq_2f_urcap_adapter__action__GripperCommand_Result;
    is_plain =
      (
...
static size_t _GripperCommand_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotiq_2f_urcap_adapter, action, GripperCommand_Result)() {
...
using _GripperCommand_Feedback__ros_msg_type = robotiq_2f_urcap_adapter__action__GripperCommand_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotiq_2f_urcap_adapter
size_t get_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GripperCommand_Feedback__ros_msg_type * ros_message = static_cast<const _GripperCommand_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotiq_2f_urcap_adapter
size_t max_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robotiq_2f_urcap_adapter__action__GripperCommand_Feedback;
    is_plain =
      (
      offsetof(DataType, reached_goal) +
      last_member_size
...
static size_t _GripperCommand_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotiq_2f_urcap_adapter, action, GripperCommand_Feedback)() {
...
// already included above
// #include "robotiq_2f_urcap_adapter/action/detail/gripper_command__functions.h"  // goal
...
using _GripperCommand_SendGoal_Request__ros_msg_type = robotiq_2f_urcap_adapter__action__GripperCommand_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, robotiq_2f_urcap_adapter, action, GripperCommand_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotiq_2f_urcap_adapter
size_t get_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GripperCommand_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _GripperCommand_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotiq_2f_urcap_adapter
size_t max_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robotiq_2f_urcap_adapter__action__GripperCommand_SendGoal_Request;
    is_plain =
      (
...
static size_t _GripperCommand_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotiq_2f_urcap_adapter, action, GripperCommand_SendGoal_Request)() {
...
using _GripperCommand_SendGoal_Response__ros_msg_type = robotiq_2f_urcap_adapter__action__GripperCommand_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotiq_2f_urcap_adapter
size_t get_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GripperCommand_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _GripperCommand_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotiq_2f_urcap_adapter
size_t max_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robotiq_2f_urcap_adapter__action__GripperCommand_SendGoal_Response;
    is_plain =
      (
...
static size_t _GripperCommand_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotiq_2f_urcap_adapter, action, GripperCommand_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotiq_2f_urcap_adapter, action, GripperCommand_SendGoal)() {
...
using _GripperCommand_GetResult_Request__ros_msg_type = robotiq_2f_urcap_adapter__action__GripperCommand_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotiq_2f_urcap_adapter
size_t get_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GripperCommand_GetResult_Request__ros_msg_type * ros_message = static_cast<const _GripperCommand_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotiq_2f_urcap_adapter
size_t max_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robotiq_2f_urcap_adapter__action__GripperCommand_GetResult_Request;
    is_plain =
      (
...
static size_t _GripperCommand_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotiq_2f_urcap_adapter, action, GripperCommand_GetResult_Request)() {
...
// already included above
// #include "robotiq_2f_urcap_adapter/action/detail/gripper_command__functions.h"  // result
...
using _GripperCommand_GetResult_Response__ros_msg_type = robotiq_2f_urcap_adapter__action__GripperCommand_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, robotiq_2f_urcap_adapter, action, GripperCommand_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotiq_2f_urcap_adapter
size_t get_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GripperCommand_GetResult_Response__ros_msg_type * ros_message = static_cast<const _GripperCommand_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotiq_2f_urcap_adapter
size_t max_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robotiq_2f_urcap_adapter__action__GripperCommand_GetResult_Response;
    is_plain =
      (
...
static size_t _GripperCommand_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotiq_2f_urcap_adapter, action, GripperCommand_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotiq_2f_urcap_adapter, action, GripperCommand_GetResult)() {
...
// already included above
// #include "robotiq_2f_urcap_adapter/action/detail/gripper_command__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _GripperCommand_FeedbackMessage__ros_msg_type = robotiq_2f_urcap_adapter__action__GripperCommand_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, robotiq_2f_urcap_adapter, action, GripperCommand_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotiq_2f_urcap_adapter
size_t get_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GripperCommand_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _GripperCommand_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotiq_2f_urcap_adapter
size_t max_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robotiq_2f_urcap_adapter__action__GripperCommand_FeedbackMessage;
    is_plain =
      (
...
static size_t _GripperCommand_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotiq_2f_urcap_adapter__action__GripperCommand_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotiq_2f_urcap_adapter, action, GripperCommand_FeedbackMessage)() {
