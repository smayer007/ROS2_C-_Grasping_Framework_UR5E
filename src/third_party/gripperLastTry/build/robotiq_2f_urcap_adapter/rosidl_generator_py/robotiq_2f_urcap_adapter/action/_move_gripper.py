...
class Metaclass_MoveGripper_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'robotiq_2f_urcap_adapter.action.MoveGripper_Goal')
            logger.debug(
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'CLOSE_GRIPPER': cls.__constants['CLOSE_GRIPPER'],
        }

    @property
    def OPEN_GRIPPER(self):
        """Message constant 'OPEN_GRIPPER'."""
        return Metaclass_MoveGripper_Goal.__constants['OPEN_GRIPPER']

    @property
    def CLOSE_GRIPPER(self):
        """Message constant 'CLOSE_GRIPPER'."""
        return Metaclass_MoveGripper_Goal.__constants['CLOSE_GRIPPER']
...
class Metaclass_MoveGripper_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robotiq_2f_urcap_adapter.action.MoveGripper_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_MoveGripper_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robotiq_2f_urcap_adapter.action.MoveGripper_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_MoveGripper_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from robotiq_2f_urcap_adapter.action import MoveGripper
...
class MoveGripper_SendGoal_Request(metaclass=Metaclass_MoveGripper_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'robotiq_2f_urcap_adapter/MoveGripper_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robotiq_2f_urcap_adapter', 'action'], 'MoveGripper_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robotiq_2f_urcap_adapter.action._move_gripper import MoveGripper_Goal
...
class Metaclass_MoveGripper_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robotiq_2f_urcap_adapter.action.MoveGripper_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from robotiq_2f_urcap_adapter.action import _move_gripper
...
class MoveGripper_SendGoal(metaclass=Metaclass_MoveGripper_SendGoal):
    from robotiq_2f_urcap_adapter.action._move_gripper import MoveGripper_SendGoal_Request as Request
    from robotiq_2f_urcap_adapter.action._move_gripper import MoveGripper_SendGoal_Response as Response
...
class MoveGripper_GetResult_Response(metaclass=Metaclass_MoveGripper_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'robotiq_2f_urcap_adapter/MoveGripper_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robotiq_2f_urcap_adapter', 'action'], 'MoveGripper_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robotiq_2f_urcap_adapter.action._move_gripper import MoveGripper_Result
...
class Metaclass_MoveGripper_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robotiq_2f_urcap_adapter.action.MoveGripper_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveGripper_GetResult(metaclass=Metaclass_MoveGripper_GetResult):
    from robotiq_2f_urcap_adapter.action._move_gripper import MoveGripper_GetResult_Request as Request
    from robotiq_2f_urcap_adapter.action._move_gripper import MoveGripper_GetResult_Response as Response
...
class Metaclass_MoveGripper_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robotiq_2f_urcap_adapter.action.MoveGripper_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveGripper_FeedbackMessage(metaclass=Metaclass_MoveGripper_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'robotiq_2f_urcap_adapter/MoveGripper_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robotiq_2f_urcap_adapter', 'action'], 'MoveGripper_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from robotiq_2f_urcap_adapter.action._move_gripper import MoveGripper_Feedback
...
class Metaclass_MoveGripper(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robotiq_2f_urcap_adapter.action.MoveGripper')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveGripper(metaclass=Metaclass_MoveGripper):
    ...
    from robotiq_2f_urcap_adapter.action._move_gripper import MoveGripper_Goal as Goal
    # The result message defined in the action definition.
    from robotiq_2f_urcap_adapter.action._move_gripper import MoveGripper_Result as Result
    # The feedback message defined in the action definition.
    from robotiq_2f_urcap_adapter.action._move_gripper import MoveGripper_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from robotiq_2f_urcap_adapter.action._move_gripper import MoveGripper_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from robotiq_2f_urcap_adapter.action._move_gripper import MoveGripper_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from robotiq_2f_urcap_adapter.action._move_gripper import MoveGripper_FeedbackMessage as FeedbackMessage
