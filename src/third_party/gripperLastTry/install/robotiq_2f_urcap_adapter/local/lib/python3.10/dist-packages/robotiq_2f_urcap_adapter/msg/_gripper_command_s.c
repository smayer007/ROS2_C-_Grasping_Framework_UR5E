...
bool robotiq_2f_urcap_adapter__msg__gripper_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robotiq_2f_urcap_adapter.msg._gripper_command.GripperCommand", full_classname_dest, 60) == 0);
  }
  robotiq_2f_urcap_adapter__msg__GripperCommand * ros_message = _ros_message;
  {  // position
...
PyObject * robotiq_2f_urcap_adapter__msg__gripper_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robotiq_2f_urcap_adapter.msg._gripper_command");
